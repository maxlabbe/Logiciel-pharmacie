...
/**
 * This class is the purchase advance research panel of the user interface. 
 * It contains the fields to search a purchase and a button to add a new one
 * 
...
public class PurchaseSearchPanel extends JPanel{
    ...
    {
	NewPurchaseFrame purchaseFrame = new NewPurchaseFrame(this.mainColor);
